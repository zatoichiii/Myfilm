...
const Header = () => {
  ...
  return (
    <Container>
      <div className={styles.wrapper}>
        <div className={styles.inner}>
          <div className={styles.info}>
            <div className={styles.logo} href="/">MYFILM</div>
      ...
      sx={{
        ...
        '& .MuiOutlinedInput-root': {
          '& fieldset': {
            borderColor: 'black', // Цвет обводки по умолчанию
          },
          '&:hover fieldset': {
            borderColor: 'black', // Цвет обводки при наведении
          },
          '&.Mui-focused fieldset': {
            borderColor: 'black', // Цвет обводки при фокусировке
          },
        },
        '& .MuiInputLabel-root': {
    ...
    />
            <div className={styles.sub}>Подписка за 1₽</div>
